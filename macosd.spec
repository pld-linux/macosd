...
MacOSD to frontend wizualizujący dla PBButtonsD - demona obsługującego
przyciski i zdarzenia związane z zasilaniem używanego na komputerach
Apple. Używa biblioteki Evas wraz z jej możliwościami antyaliasingu i
alpha-blendingu przy rysowaniu. Uboższe w bajery Xosd także może być
używane do rysowania okienek ponad obrazem. Format motywów jest
